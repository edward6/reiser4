...
static reiserfs_opaque_t *oid40_open(void *area_start, void *area_end) {
...
static reiserfs_opaque_t *oid40_create(void *area_start, void *area_end) {
    reiserfs_oid40_t *oid;
...
static reiserfs_plugin_t oid40_plugin = {
	...
	.open = (reiserfs_opaque_t *(*)(void *, void *))oid40_open,

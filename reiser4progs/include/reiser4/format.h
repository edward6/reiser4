...
extern reiserfs_plugin_id_t reiserfs_format_journal_plugin_id(reiserfs_format_t *format);
extern reiserfs_plugin_id_t reiserfs_format_alloc_plugin_id(reiserfs_format_t *format);
extern reiserfs_plugin_id_t reiserfs_format_oid_plugin_id(reiserfs_format_t *format);

...
extern errno_t reiserfs_format_valid(reiserfs_format_t *format, 
    int flags);
...
extern count_t reiserfs_format_get_len(reiserfs_format_t *format);
...
extern const char *reiserfs_format_name(reiserfs_format_t *format);

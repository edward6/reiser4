...
extern void reiserfs_oid_fini(reiserfs_fs_t *fs);
...
extern uint64_t reiserfs_oid_root_parent_objectid(reiserfs_fs_t *fs);
extern uint64_t reiserfs_oid_root_objectid(reiserfs_fs_t *fs);

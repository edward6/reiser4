...
inline int reiserfs_misc_find_first_zero_bit(const void *vaddr, unsigned size) {
#ifndef WORDS_BIGENDIAN    
...
inline int reiserfs_misc_find_next_zero_bit(const void *vaddr, unsigned size, unsigned offset) {
#ifndef WORDS_BIGENDIAN    

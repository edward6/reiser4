...
extern int build_entry_key(const struct inode *dir, const struct qstr *name, reiser4_key * result);
extern int build_readdir_stable_entry_key(const struct inode *dir, const struct qstr *name, reiser4_key * result);

...
extern int initr_fsw32(reiser4_aid *raid, void **tab,
		       int num_buckets, int nums_bits);
extern void replace_fsw32(reiser4_aid *raid, void **target);
extern void free_fsw32(void *tab);
extern void doner_fsw32(void **tab);

extern int initv_fsw32(bucket_t *buckets, void **tab,
...
extern int inc_fsw32(reiser4_aid *raid, void *tab, u64 pos, bucket_t new);
extern int dec_fsw32(reiser4_aid *raid, void *tab, u64 pos, bucket_t victim);
extern int spl_fsw32(reiser4_aid *raid, u32 fact_bits);
extern void pack_fsw32(reiser4_aid *raid, char *to, u64 src_off, u64 count);
extern void unpack_fsw32(reiser4_aid *raid, void *tab,
			 char *from, u64 dst_off, u64 count);
extern void dump_fsw32(reiser4_aid *raid, void *tab,

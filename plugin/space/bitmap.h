...
extern int bitmap_init_allocator(reiser4_space_allocator *,
				 struct super_block *, void *);
extern int bitmap_destroy_allocator(reiser4_space_allocator *,
				    struct super_block *);
...
extern void bitmap_check_blocks(const reiser4_block_nr *,
				const reiser4_block_nr *, int);

#endif

extern void bitmap_dealloc_blocks(reiser4_space_allocator *,
				  reiser4_block_nr, reiser4_block_nr);
...
extern void get_bitmap_blocknr(struct super_block *, bmap_nr_t,
			       reiser4_block_nr *);

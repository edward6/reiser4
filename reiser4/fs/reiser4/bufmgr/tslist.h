...
PREFIX##_list_link_ok (PREFIX##_list_link  *_link)                                            \
{                                                                                             \
...
{                                                                                             \
  return ((PREFIX##_list_link *) head) == (& item->LINK_NAME);                                \
                                                                                              ...
                                                                                              \
static __inline__ int                                                                         \
PREFIX##_list_empty (PREFIX##_list_head  *head)                                               \
{                                                                                             \

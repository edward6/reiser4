cmd_fs/reiser4/inode_ops.o := ccache cc -Wp,-MD,fs/reiser4/.inode_ops.o.d -D__KERNEL__ -Iinclude -Wall -g -Wstrict-prototypes -Wno-trigraphs -O2 -fno-strict-aliasing -fno-common -pipe -mpreferred-stack-boundary=2 -march=i686 -Iinclude/asm-i386/mach-default -g -nostdinc -iwithprefix include  -Wpointer-arith -Wwrite-strings -Woverloaded-virtual -Wformat -Wsynth -Wundef -Wcast-align -Wlarger-than-4096 -Wnon-virtual-dtor -Wreorder -Wsign-promo -Wuninitialized -Wunused -Wcomment -Wno-nested-externs -Wno-sign-compare  -DKBUILD_BASENAME=inode_ops -DKBUILD_MODNAME=reiser4 -c -o fs/reiser4/inode_ops.o fs/reiser4/inode_ops.c

deps_fs/reiser4/inode_ops.o := \
  fs/reiser4/inode_ops.c \
...
fs/reiser4/inode_ops.o: $(deps_fs/reiser4/inode_ops.o)
